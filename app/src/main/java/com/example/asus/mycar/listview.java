...
public class listview extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] id = bundle2.getStringArray("id");
      ...
      //  imageid = imageidl.toArray(imageid);
        ...
        customlist adapter = new customlist(this, R.layout.eachitem, rowItems);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
                                    ...
                                    long id)
            {
               ...
               TextView com = (TextView) v.findViewById(R.id.company);
                ...
                Intent intent = new Intent(listview.this,itemdetails.class);
